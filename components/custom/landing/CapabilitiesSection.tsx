  ...
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-32 relative z-10 text-center">
      ...
      <h2 className="text-4xl  tracking-[-3px]  text-slate-900 mt-2">
        Where search flexibility meets
        <br />
      ...
      <p className="text-slate-500 max-w-xl font-light mx-auto mt-4 text-sm">
        Visual components detailing our AI-enriched news extraction
        capabilities.
      </p>

      {/* 2x2 Visual Grid */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto mt-16 text-left">
        {/* Block 1: Citation Graphs */}
        <div className="bg-white border border-slate-200/60 rounded-[2.5rem] p-8  flex flex-col md:flex-row gap-8 items-center">
          ...
          <div className="w-[180px] h-[130px] rounded-2xl border border-slate-200/80 bg-slate-50/50 p-4 flex flex-col justify-between shadow-inner shrink-0">
            ...
            <span className="text-[9px] text-slate-400 font-mono">
              Linked: 14 publications
            </span>
          </div>
        </div>

        {/* Block 2: AI Summaries & translations */}
        <div className="bg-white border border-slate-200/60 rounded-[2.5rem] p-8  flex flex-col md:flex-row gap-8 items-center">
          <div className="flex-1 space-y-4">
            <h3 className="text-xl tracking-[-1px] text-slate-900">
            ...
            <p className="text-slate-500 text-xs leading-relaxed">
              Retrieve concise synthesized event summaries and high-fidelity
              bilingual translations generated by LLM instances.
            </p>
          </div>
        ...
        <div className="bg-white border border-slate-200/60 rounded-[2.5rem] p-8  flex flex-col md:flex-row gap-8 items-center">
          <div className="flex-1 space-y-4">
            ...
            <p className="text-slate-500 text-xs leading-relaxed">
              Leverage 384-dimensional vector search to find conceptually
              similar news events using natural language queries.
            </p>
          </div>
        ...
        <div className="bg-white border border-slate-200/60 rounded-[2.5rem] p-8  flex flex-col md:flex-row gap-8 items-center">
          <div className="flex-1 space-y-4">
            ...
            <p className="text-slate-500 text-xs leading-relaxed">
              Integrate server-sent event (SSE) streams and push webhooks to
              receive news alerts immediately as articles are indexed.
            </p>
          </div>

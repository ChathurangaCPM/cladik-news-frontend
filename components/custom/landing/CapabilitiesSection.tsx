  ...
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-32 relative z-10 text-center">
      ...
      <h2 className="text-4xl  tracking-[-3px]  text-slate-900 mt-2">
        ...
        <br />
        <span className=" tracking-[-3px] font-heading italic text-[#2b86ff]">
          Intelligent Technology
        </span>
      </h2>
      <p className="text-slate-500 max-w-xl font-light mx-auto mt-4 text-sm">
        Aeline-styled visual components detailing our core story indexing
        capabilities.
      </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto mt-16 text-left">
        ...
        <div className="bg-white border border-slate-200/60 rounded-[2.5rem] p-8 shadow-sm flex flex-col md:flex-row gap-8 items-center">
          <div className="flex-1 space-y-4">
            <h3 className="text-xl tracking-[-1px] text-slate-900">
              Automatic consensus
            </h3>
            <p className="text-slate-500 text-xs leading-relaxed">
              We map coverage from multiple publications to a single clean
              consensus report, highlighting unique angles and removing
              duplicates.
            </p>
          </div>
        ...
        <div className="bg-white border border-slate-200/60 rounded-[2.5rem] p-8 shadow-sm flex flex-col md:flex-row gap-8 items-center">
          <div className="flex-1 space-y-4">
            ...
            <p className="text-slate-500 text-xs leading-relaxed">
              Seamless and professional bilingual translations automatically
              created by advanced generative language models.
            </p>
          </div>
        ...
        <div className="bg-white border border-slate-200/60 rounded-[2.5rem] p-8 shadow-sm flex flex-col md:flex-row gap-8 items-center">
          <div className="flex-1 space-y-4">
            ...
            <p className="text-slate-500 text-xs leading-relaxed">
              Search story concepts conceptually, letting you locate updates
              based on matching subjects and thoughts rather than exact
              keywords.
            </p>
          </div>
          <div className="w-[180px] h-[130px] rounded-2xl border border-slate-200/80 bg-slate-50/50 p-4 flex flex-col justify-between shadow-inner shrink-0 relative overflow-hidden">
            <div className="absolute inset-0 flex items-center justify-center text-[10px] font-mono text-slate-400 flex-wrap gap-1 p-2">
              <span className="bg-slate-100 border px-1.5 py-0.5 rounded">
                Climate
              </span>
              <span className="bg-slate-100 border px-1.5 py-0.5 rounded">
                Policy
        ...
        <div className="bg-white border border-slate-200/60 rounded-[2.5rem] p-8 shadow-sm flex flex-col md:flex-row gap-8 items-center">
          <div className="flex-1 space-y-4">
            ...
            <p className="text-slate-500 text-xs leading-relaxed">
              Continual scanning and indexing operations tracking worldwide
              publications 24/7.
            </p>
          </div>
